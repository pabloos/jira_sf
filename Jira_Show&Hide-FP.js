<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        function runShowAndHide() {
            ...
            var checks_array     = ["customfield_11278-1", "customfield_11278-2", "customfield_11278-3", "customfield_11278-4", "customfield_11278-5"].map(id => document.getElementById(id))
            let dtp_fields       = ["customfield_11101", "customfield_11366", "customfield_11339"].map(id => document.getElementById(id).parentElement)
            ...
            [dtp_fields, icr_req_fields, plt_fields, preflight_fields, final_eye_fields].map((section, index) => (function() {
                section.forEach(field => {
                    field.style.display = (function() {
                        return (checks_array[index].checked ? show : hide)
                    })() //we need to call the function. Otherwise this returns a pointer
                })
