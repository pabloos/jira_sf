            ...
            function runShowAndHide() {
                ...
                function show_hide_DTP_fields() {
                    dtp_fields_array.forEach(element => {
                        element.style.display = (function() { return (DTP_check.checked ? show : hide) })()
                    })
                }

                function show_hide_ICR_fields() {
                    icr_req_field.style.display = (function() { return (ICR_check.checked ? show : hide) })()
                }

                function show_hide_PLT_fields() {
                    plt_fields_array.forEach(element => {
                        element.style.display = (function() { return (PLT_check.checked ? show : hide) })()
                    })
                }

                function show_hide_Preflight_fields() {
                    preflight_fields_array.forEach(element => {
                        element.style.display = (function() { return (Preflight_check.checked ? show : hide) })()
                    })
                }

                function show_hide_finalEye_fields() {
                    final_eye_ins_field.style.display = (function() { return (Final_Eye_check.checked ? show : hide) })()
                }
